...
from model.ModelBuilder import build_resnet50, build_resnet34, build_small
...
def main():
    ...
    # model = build_resnet50(classes=num_classes, input_shape=(input_size, input_size, 3))
    model = build_resnet34(classes=num_classes, input_shape=(input_size, input_size, 3))
    model.summary()
