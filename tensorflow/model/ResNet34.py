...
class ResNet34(ResNet):
    ...
    def build(self, model_inputs, is_training: bool, reuse: bool):
        with variable_scope('resnet34', reuse=reuse):
            with variable_scope('head'):
                head_end = self._head(model_inputs, is_training)
            with variable_scope('64_filter_block'):
            ...
            with variable_scope('128_filter_block'):
            ...
            with variable_scope('256_filter_block'):
            ...
            with variable_scope('512_filter_block'):
            ...
            with variable_scope('classification'):
